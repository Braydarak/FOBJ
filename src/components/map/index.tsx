  ...
  return (
    ...
    >
      <MapContainer
        ...
        doubleClickZoom={!disableDoubleClickZoom}
        boxZoom={!disableBoxZoom}
      >
        <TileLayer
        ...
        />
        {coordinates &&
          coordinates.length === 2 && ( // Verificar si hay coordenadas válidas
        ...
        <LocationMarker onClick={handleMarkerClick} />{" "}
        {/* Manejo de clic en el mapa */}
        {showSearchControl && <AddSearchControl />}{" "}
